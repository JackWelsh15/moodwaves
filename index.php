        ...
        <nav class="navbar is-transparent">
            <div class="container">
              ...
              <span class="navbar-item">
                <a class="button is-white is-outlined is-active">
                  <span class="icon">
    ...
    <div id="sign-in-modal" class="modal">
        ...
        <div class="modal-content">
            <div class="modal-card">
                <form action="../backend/functions.php" id="signInForm" method="post">
    ...
    <div class="hero-body">
        <div class="container has-text-centered">
                    ...
                    <form id="search" name="search" method="post">
                        <div class="field is-grouped">
                            <div class="control is-expanded has-icons-left">
                                <input id="search-input" class="input" type="text" name="query"
                                       placeholder="e.g. 'James Bay'">
                                <span class="icon is-small is-left">
                      <i class="fa fa-search"></i>
                    </span>
                            </div>
            ...
            <div class="playlist-table">
                <?php
                if (isset($query)) { //check pointer reference is allocated, then execute function
